...
public class mycartgetdata  {
    ...
    private String dressquant ;
    private String dresstotalprice;
    private String duration;
    private String sizedata;
    private String sizecattype;
    ...
    mycartgetdata(String name, String size_available, String description , String tagname ,  String dress_code , String Productparent_type , String retailercode ,  String retailername ,  String dressquant , String dresstotalprice , String duration , String sizedata ,  String dress_sizetitle,String product_likes , String price, String no_of_views, String product_id, String total_ratings , String imgurl1, String imgurl2, String imgurl3, String imgurl4, String imgurl5, String imgurl6 , String sizecattype , String sizeselected)
    {
        this.name = name;
        ...
        this.dressquant = dressquant;
        this.dresstotalprice = dresstotalprice;
    ...
    public String getDressquant() {
        return dressquant;
    }

    public String getDresstotalprice() {
        return dresstotalprice;
    }
