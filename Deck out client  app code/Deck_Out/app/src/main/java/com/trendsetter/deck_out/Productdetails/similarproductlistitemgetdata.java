...
public class similarproductlistitemgetdata {
    ...
    similarproductlistitemgetdata()
        {

        }

    similarproductlistitemgetdata(String name, String size_available, String dress_code , String dress_sizetitle , String Productparent_type ,String product_likes , String description, String price, String no_of_views, String product_id, String total_ratings , String imgurl1, String imgurl2, String imgurl3, String imgurl4, String imgurl5, String imgurl6)
        {
            this.name = name;
