...
public class mywishlistgetdata {
    ...
    mywishlistgetdata(String name, String size_available, String description ,String Productparent_type , String retailercode ,  String retailername ,  String dress_code , String dress_sizetitle,String product_likes , String price, String no_of_views, String product_id, String total_ratings , String imgurl1, String imgurl2, String imgurl3, String imgurl4)
    {
        this.name = name;
