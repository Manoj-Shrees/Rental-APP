...
public class legalexplistadapter extends BaseExpandableListAdapter {

    private Context context;
    private ArrayList<String> menu;
    private HashMap<String, String> listDataansChild;

    public legalexplistadapter(Context context, HashMap<String, String> listDataansChild, ArrayList<String> menu) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.legalexpsubmenu, null);
        }



        TextView anstxtview = (TextView) convertView
                .findViewById(R.id.legalanstxt);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = infalInflater.inflate(R.layout.legalexphead, null);
        }

        TextView questxtview = (TextView) convertView
                .findViewById(R.id.legaltopictext);
        questxtview.setText(headerTitle);


        ImageView arrowimg = convertView.findViewById(R.id.legalquesonclickicon);
